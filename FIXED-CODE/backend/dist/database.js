...
function _addProject() {
  _addProject = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(projectName, createdOn, description, type, files, members, owner, version, status, projectImage, checkedOutBy, checkInMessages, userId) {
    var user, ownerUsername, membersArr, fileList, messagesMap, projectDoc, result, projectId, _t7;
    return _regenerator().w(function (_context8) {
      while (1) switch (_context8.p = _context8.n) {
        ...
        case 1:
          ...
          messagesMap = {};
          if (checkInMessages && _typeof(checkInMessages) === "object" && !Array.isArray(checkInMessages)) {
            messagesMap = _objectSpread({}, checkInMessages);
