...
const Splash = () => {
    return (
        <div className="splashBody">
            ...
            <div id="flow"><img alt="flow" src="/assets/images/flow.png" width="600"/></div>
            <div id="favourite">your new favourite version control site <img alt="greater" id="greater" src="/assets/images/greater.png"/></div>
